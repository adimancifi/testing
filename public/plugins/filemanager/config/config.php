...
if ( $user_group == 'root' ) {
	...
	$hidden_folders = array('medium','user','favicon');
}

$server_link = preg_replace("/\/plugins\/filemanager\/(dialog\.php$)/","",$_SERVER['PHP_SELF']);
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => $server_link.'/uploads/',
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	// -1: There is no lazy loading at all.
	//  0: Always lazy-load images.
	// 0+: The minimum number of the files in a directory
	...
	*/
	...
	'rename_folders'      => $modify_access,
	
	'download_files'      => true, // allow download files or just preview
	'upload_files'        => $write_access,
	'create_text_files'   => $write_access, // only create files with exts. defined in 
	'delete_files'        => $delete_access,
	'rename_files'        => $modify_access,
	...
	'copy_cut_max_size' => 1, // set 'FALSE' for no limit // defines size limit for paste in MB / operation
	'copy_cut_max_count' => 1, // set 'FALSE' for no limit // defines file count limit for paste / operation
	//IF any of these limits reached, operation won't start and generate warning

	'preview_text_files' => $read_access,
	...
	'ext_file' => array( 'doc', 'docx', 'pdf', 'xls', 'xlsx', 'txt', 'psd', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai', 'kmz','dwg', 'dxf', 'hpgl', 'plt', 'spl', 'step', 'stp', 'iges', 'igs', 'sat', 'cgm', 'tiff',''), //Files
	...
	// block extension
	'ext_blacklist' => ['exe','bat','cmd','php','js'], //['exe','bat','jpg'],
	
	'empty_filename' => false, //Empty filename permits like .htaccess, .env, ...
	...
	*/
	...
	'fixed_path_from_filemanager'          => array( '../../uploads/medium/' ),
	'fixed_image_creation_name_to_prepend' => array( '' ),
	'fixed_image_creation_to_append'       => array( '' ),
	'fixed_image_creation_width'           => array( $medium_width ),
	'fixed_image_creation_height'          => array( $medium_height ),
	'fixed_image_creation_option'          => array( 'crop', 'crop' ),
	...
	'relative_path_from_current_pos'          => array( 'medium/' ), 
	'relative_image_creation_name_to_prepend' => array( '' ), 
	'relative_image_creation_name_to_append'  => array( '' ), 
	'relative_image_creation_width'           => array( $medium_width ), 
	'relative_image_creation_height'          => array( $medium_height ), 
